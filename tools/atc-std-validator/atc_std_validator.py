...
CATS = ["governance", "architecture", "repository", "development", "security",
        ...
        "bug", "net", "zkp", "ai-dev", "aas", "enterprise", "readme", "md", "sc", "desc", "version", "audit", "ai-decision"]
...
def validate(path, registry_path):
    ...
    sid = meta.get("id", "")
    _ok02 = re.match(r"^ATC-STD-(?:BUG-|NET-|ZKP-|AI-DEV-|README-|MD-|SC-|DESC-|VERSION-|AUDIT-|AI-DECISION-)?[0-9]{3,}$", sid) or re.match(r"^ATC-(?:AAS|ENT)-[0-9]{3,}$", sid)
