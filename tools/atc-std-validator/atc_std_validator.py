...
CATS = ["governance", "architecture", "repository", "development", "security",
        ...
        "bug", "net", "zkp", "ai-dev", "aas", "enterprise", "readme", "md", "sc", "desc", "version", "audit", "ai-decision", "update", "improvement", "ai-gov", "compat", "milestone", "framework", "repo-audit", "agent-operating", "master-audit", "protocol", "taxonomy", "governance-core"]
