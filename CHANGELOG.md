...
- SCR-0077: Hub-PR-Blockade alternativ gelöst — #1/#2/#3 konfliktfrei zu PR #4 konsolidiert (RCA: Identitätstrennung ShivaCoreDev = PR-Autor, Protection-PUT für OAuth-Token 404); Owner-Aktion auf 1× Approve reduziert.
