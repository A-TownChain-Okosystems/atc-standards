...
state:
  ...
  generated_at: "2026-09-13 01:20 UTC+2"
...
- `profiles/` — 29 verbindliche Standards-Profile je Repository (Compliance-Vertrag, ATC-STD-LIB-001 §8) + `docs/architecture/` — Zielarchitektur
...
├── profiles/       # 29 Standards-Profile je Repository (Compliance-Vertrag, ATC-STD-LIB-001 §8)
