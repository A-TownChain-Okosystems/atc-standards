...
**Implementierungs-KPI:** 444 Standards normativ definiert — 62 enforced, 129 implemented, 240 specification-only (Zielsysteme im qualitätsgetriebenen Rebuild AD-023/AD-045). Die Aussage „444 Standards implementiert“ ist unzulässig (SCR-0048).
...
- `standards/` — 443 Standard-Dateien in 50 Familien
