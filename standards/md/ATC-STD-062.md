...
# ATC-STD-062 — Wiki Standard (v1.2.0, APPROVED)
...
ATC-STD-062 (Wiki Standard) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Wiki Standard) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Wiki Standard** im Katalog-Slot ATC-STD-062 der Familie Dokumentationsstandards
...
**Katalog-Referenz:** Alte Wiki-Struktur archiviert; künftiges Wissens-Management
...
## §6 Slot-Spezifikation Wiki Standard — verbindliche Prüfkriterien
...
- **P1** (MUSS): Wissensgebiete und Aktualitaetspflicht — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Quellen- und Referenzdisziplin — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Archiv-/Vault-Disziplin fuer Altbestand — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Zugriffskonvention (SSOT-Referenz statt Kopie) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Ehrlichkeitsregel bei Legacy-Aussagen — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Dokumentationsstandards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Wissensgebiete und Aktualitaetspflicht
- **REQ-STD-012** (§6/P2): Quellen- und Referenzdisziplin
- **REQ-STD-013** (§6/P3): Archiv-/Vault-Disziplin fuer Altbestand
- **REQ-STD-014** (§6/P4): Zugriffskonvention (SSOT-Referenz statt Kopie)
- **REQ-STD-015** (§6/P5): Ehrlichkeitsregel bei Legacy-Aussagen
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Dokumentationsstandards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-062 (Familie Dokumentationsstandards, FAM-04) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-062 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
