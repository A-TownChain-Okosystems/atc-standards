...
standard:
  id: ATC-STD-249
  title: "BSC Integration Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-249 — BSC Integration (v1.2.0, APPROVED)
...
ATC-STD-249 (BSC Integration) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (BSC Integration) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **BSC Integration** im Katalog-Slot ATC-STD-249 der Familie Interoperability
...
## §6 Slot-Spezifikation BSC Integration — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-249 (Familie Interoperability, FAM-14) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-249 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
