...
standard:
  id: ATC-STD-276
  title: "External API Binding Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-276 — External API Binding (v1.2.0, APPROVED)
...
ATC-STD-276 (External API Binding) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (External API Binding) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **External API Binding** im Katalog-Slot ATC-STD-276 der Familie Oracle & External Data
...
## §6 Slot-Spezifikation External API Binding — verbindliche Prüfkriterien
...
- **P1** (MUSS): Schnittstellenvertrag (Version, Pfad, Schema) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Authentisierung ueber Identity-Layer — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Rate-Limits je Endpunkt — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Fehlercode-Katalog komplett und stabil — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Doku-Sync-Pflicht (keine Ghost-Endpunkte) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Oracle & External Data-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Schnittstellenvertrag (Version, Pfad, Schema)
- **REQ-STD-012** (§6/P2): Authentisierung ueber Identity-Layer
- **REQ-STD-013** (§6/P3): Rate-Limits je Endpunkt
- **REQ-STD-014** (§6/P4): Fehlercode-Katalog komplett und stabil
- **REQ-STD-015** (§6/P5): Doku-Sync-Pflicht (keine Ghost-Endpunkte)
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Oracle & External Data-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-276 (Familie Oracle & External Data, FAM-16) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-276 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
