...
# ATC-STD-240 — Interoperability (v1.2.0, APPROVED)
...
ATC-STD-240 (Interoperability) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Interoperability) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Interoperability** im Katalog-Slot ATC-STD-240 der Familie Interoperability
...
## §6 Slot-Spezifikation Interoperability — verbindliche Prüfkriterien
...
- **P1** (MUSS): Kompatibilitaetsklasse je Kopplung — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Mapping-Regeln beidseitig dokumentiert — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Versionierung und Parallelbetrieb — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Fehlerbehandlung an Grenzflaechen — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Conformance-Nachweis (CONF) — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Kompatibilitaetsklasse je Kopplung
- **REQ-STD-012** (§6/P2): Mapping-Regeln beidseitig dokumentiert
- **REQ-STD-013** (§6/P3): Versionierung und Parallelbetrieb
- **REQ-STD-014** (§6/P4): Fehlerbehandlung an Grenzflaechen
- **REQ-STD-015** (§6/P5): Conformance-Nachweis (CONF)
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-240 (Familie Interoperability, FAM-14) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-240 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
