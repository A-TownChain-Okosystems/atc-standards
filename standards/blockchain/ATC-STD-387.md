...
# ATC-STD-387 — Oracle (v1.2.0, APPROVED)
...
ATC-STD-387 (Oracle) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Oracle) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Oracle** im Katalog-Slot ATC-STD-387 der Familie DeFi Standards
...
## §6 Slot-Spezifikation Oracle — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-387 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-387 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
