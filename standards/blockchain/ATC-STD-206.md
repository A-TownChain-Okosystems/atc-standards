...
standard:
  id: ATC-STD-206
  title: "Staking Rewards Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-206 — Staking Rewards (v1.2.0, APPROVED)
...
ATC-STD-206 (Staking Rewards) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Staking Rewards) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Staking Rewards** im Katalog-Slot ATC-STD-206 der Familie Token Standards
...
## §6 Slot-Spezifikation Staking Rewards — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Token Standards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Token Standards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-206 (Familie Token Standards, FAM-12) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-206 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
