...
# ATC-STD-274 — Price Feeds (v1.2.0, APPROVED)
...
ATC-STD-274 (Price Feeds) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Price Feeds) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Price Feeds** im Katalog-Slot ATC-STD-274 der Familie Oracle & External Data
...
## §6 Slot-Spezifikation Price Feeds — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Oracle & External Data-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Oracle & External Data-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-274 (Familie Oracle & External Data, FAM-16) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-274 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
