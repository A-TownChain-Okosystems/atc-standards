...
# ATC-STD-271 — External Data (v1.2.0, APPROVED)
...
ATC-STD-271 (External Data) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (External Data) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **External Data** im Katalog-Slot ATC-STD-271 der Familie Oracle & External Data
...
## §6 Slot-Spezifikation External Data — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-271 (Familie Oracle & External Data, FAM-16) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-271 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
