...
# ATC-STD-389 — DeFi Security (v1.2.0, APPROVED)
...
ATC-STD-389 (DeFi Security) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (DeFi Security) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **DeFi Security** im Katalog-Slot ATC-STD-389 der Familie DeFi Standards
...
## §6 Slot-Spezifikation DeFi Security — verbindliche Prüfkriterien
...
- **P6** (MUSS): Oekonomiemodell mit Grenzen und Annahmen — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Risikoparameter (Exposure-Caps, Breaker) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Oracle-Ausfallszenarien definiert — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Oekonomiemodell mit Grenzen und Annahmen
- **REQ-STD-017** (§6/P7): Risikoparameter (Exposure-Caps, Breaker)
- **REQ-STD-018** (§6/P8): Oracle-Ausfallszenarien definiert
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-389 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-389 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
