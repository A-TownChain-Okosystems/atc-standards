...
# ATC-STD-384 — Staking (v1.2.0, APPROVED)
...
ATC-STD-384 (Staking) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Staking** im Katalog-Slot ATC-STD-384 der Familie DeFi Standards
...
- **P5** (MUSS): Familienkonformitaet: DeFi Standards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: DeFi Standards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-384 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-384 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
