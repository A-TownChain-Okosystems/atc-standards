...
standard:
  id: ATC-STD-246
  title: "Ethereum Integration Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-246 — Ethereum Integration (v1.2.0, APPROVED)
...
ATC-STD-246 (Ethereum Integration) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Ethereum Integration) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Ethereum Integration** im Katalog-Slot ATC-STD-246 der Familie Interoperability
...
## §6 Slot-Spezifikation Ethereum Integration — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Interoperability-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Interoperability-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-246 (Familie Interoperability, FAM-14) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-246 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
