...
# ATC-STD-361 — Address (v1.2.0, APPROVED)
...
ATC-STD-361 (Address) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Address** im Katalog-Slot ATC-STD-361 der Familie Wallet Standards
...
## §6 Slot-Spezifikation Address — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-361 (Familie Wallet Standards, FAM-22) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-361 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
