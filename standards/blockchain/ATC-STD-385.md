...
# ATC-STD-385 — Lending (v1.2.0, APPROVED)
...
ATC-STD-385 (Lending) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Lending** im Katalog-Slot ATC-STD-385 der Familie DeFi Standards
...
## §6 Slot-Spezifikation Lending — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-385 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-385 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
