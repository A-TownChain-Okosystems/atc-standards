...
# ATC-STD-385 — Lending (v1.0.0, APPROVED)
...
ATC-STD-385 (Lending) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
...
**Gilt:** Der durch den Slot-Titel (Lending) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Lending**. Er ist dem Katalog-Slot ATC-STD-385 der
...
(Lending) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-385 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
*ATC-STD-385 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
