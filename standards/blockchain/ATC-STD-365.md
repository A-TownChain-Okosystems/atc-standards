...
# ATC-STD-365 — Hardware Wallet (v1.2.0, APPROVED)
...
ATC-STD-365 (Hardware Wallet) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Hardware Wallet) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Hardware Wallet** im Katalog-Slot ATC-STD-365 der Familie Wallet Standards
...
## §6 Slot-Spezifikation Hardware Wallet — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-365 (Familie Wallet Standards, FAM-22) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-365 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
