...
standard:
  id: ATC-STD-380
  title: "DeFi Architecture Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-380 — DeFi Architecture (v1.2.0, APPROVED)
...
ATC-STD-380 (DeFi Architecture) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (DeFi Architecture) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **DeFi Architecture** im Katalog-Slot ATC-STD-380 der Familie DeFi Standards
...
## §6 Slot-Spezifikation DeFi Architecture — verbindliche Prüfkriterien
...
- **P1** (MUSS): Oekonomiemodell mit Grenzen und Annahmen — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Risikoparameter (Exposure-Caps, Breaker) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Oracle-Ausfallszenarien definiert — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Liquiditaets-/Ausnahmezustandsregeln — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Simulation vor Parameteraenderung — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Oekonomiemodell mit Grenzen und Annahmen
- **REQ-STD-012** (§6/P2): Risikoparameter (Exposure-Caps, Breaker)
- **REQ-STD-013** (§6/P3): Oracle-Ausfallszenarien definiert
- **REQ-STD-014** (§6/P4): Liquiditaets-/Ausnahmezustandsregeln
- **REQ-STD-015** (§6/P5): Simulation vor Parameteraenderung
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-380 (Familie DeFi Standards, FAM-23) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-380 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
