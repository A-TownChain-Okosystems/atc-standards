...
# ATC-STD-205 — Minting (v1.2.0, APPROVED)
...
ATC-STD-205 (Minting) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Minting) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Minting** im Katalog-Slot ATC-STD-205 der Familie Token Standards
...
## §6 Slot-Spezifikation Minting — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-205 (Familie Token Standards, FAM-12) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-205 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
