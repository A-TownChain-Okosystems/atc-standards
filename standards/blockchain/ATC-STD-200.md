...
# ATC-STD-200 — ATC Token (v1.2.0, APPROVED)
...
ATC-STD-200 (ATC Token) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (ATC Token) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **ATC Token** im Katalog-Slot ATC-STD-200 der Familie Token Standards
...
## §6 Slot-Spezifikation ATC Token — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-200 (Familie Token Standards, FAM-12) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-200 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
