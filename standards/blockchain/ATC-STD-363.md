...
standard:
  id: ATC-STD-363
  title: "Transaction Signing Standard"
  version: "1.0.0"
  status: approved
  category: blockchain
...
# ATC-STD-363 — Transaction Signing (v1.0.0, APPROVED)

> **Status:** APPROVED (v1.0.0, §30-eingefroren) — Grundgerüst-Standard aus Katalog-Slot der Familie
> Wallet Standards (FAM-22); erstellt via SCR-0030. Inhaltliche Elaborierung (Volltext,
...
ATC-STD-363 (Transaction Signing) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
der Familie **Wallet Standards** (FAM-22, Range ATC-STD-360..368) im ATC Enterprise Standards
...
**Gilt:** Der durch den Slot-Titel (Transaction Signing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Transaction Signing**. Er ist dem Katalog-Slot ATC-STD-363 der
Familie Wallet Standards (FAM-22) zugeordnet; die Zuordnung folgt registry/framework.yaml
...
(Transaction Signing) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-363 (Familie Wallet Standards, FAM-22) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
- registry/framework.yaml (FAM-22), registry/standards.yaml (Eintrag via SCR-0030)

*ATC-STD-363 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
