...
# ATC-STD-363 — Transaction Signing (v1.2.0, APPROVED)
...
ATC-STD-363 (Transaction Signing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Transaction Signing** im Katalog-Slot ATC-STD-363 der Familie Wallet Standards
...
## §6 Slot-Spezifikation Transaction Signing — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Wallet Standards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Wallet Standards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-363 (Familie Wallet Standards, FAM-22) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-363 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
