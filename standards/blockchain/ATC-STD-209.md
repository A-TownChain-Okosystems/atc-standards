...
standard:
  id: ATC-STD-209
  title: "Token Allocation Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-209 — Token Allocation (v1.2.0, APPROVED)
...
ATC-STD-209 (Token Allocation) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Token Allocation) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Token Allocation** im Katalog-Slot ATC-STD-209 der Familie Token Standards
...
## §6 Slot-Spezifikation Token Allocation — verbindliche Prüfkriterien
...
- **P1** (MUSS): Tokenmodell und Supply-Regeln — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Operationen (Mint/Burn/Transfer) mit Grenzen — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Determinismus (Rundung/Ueberlauf) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Metadaten-Versionierung — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Audit-Gate fuer Aenderungen — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Token Standards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Tokenmodell und Supply-Regeln
- **REQ-STD-012** (§6/P2): Operationen (Mint/Burn/Transfer) mit Grenzen
- **REQ-STD-013** (§6/P3): Determinismus (Rundung/Ueberlauf)
- **REQ-STD-014** (§6/P4): Metadaten-Versionierung
- **REQ-STD-015** (§6/P5): Audit-Gate fuer Aenderungen
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Token Standards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-209 (Familie Token Standards, FAM-12) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-209 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
