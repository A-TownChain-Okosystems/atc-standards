...
standard:
  id: ATC-STD-245
  title: "EVM Compatibility Standard"
  version: "1.2.0"
  status: approved
  category: blockchain
...
# ATC-STD-245 — EVM Compatibility (v1.2.0, APPROVED)
...
ATC-STD-245 (EVM Compatibility) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (EVM Compatibility) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **EVM Compatibility** im Katalog-Slot ATC-STD-245 der Familie Interoperability
...
## §6 Slot-Spezifikation EVM Compatibility — verbindliche Prüfkriterien
...
- **P1** (MUSS): Befehlssatz und Ausfuehrungssemantik — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Speicher-/Stack-Modell und Grenzen — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Determinismus und Messbarkeit (Gas) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Konformanz gegen Spezifikation — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Sandbox-/Isolationsregeln — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Befehlssatz und Ausfuehrungssemantik
- **REQ-STD-012** (§6/P2): Speicher-/Stack-Modell und Grenzen
- **REQ-STD-013** (§6/P3): Determinismus und Messbarkeit (Gas)
- **REQ-STD-014** (§6/P4): Konformanz gegen Spezifikation
- **REQ-STD-015** (§6/P5): Sandbox-/Isolationsregeln
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-245 (Familie Interoperability, FAM-14) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-245 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
