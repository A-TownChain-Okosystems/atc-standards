...
# ATC-STD-187 — Staking (v1.2.0, APPROVED)
...
ATC-STD-187 (Staking) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Staking** im Katalog-Slot ATC-STD-187 der Familie Blockchain Standards
...
## §6 Slot-Spezifikation Staking — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-187 (Familie Blockchain Standards, FAM-11) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-187 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
