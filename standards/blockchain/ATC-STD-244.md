...
# ATC-STD-244 — IBC (v1.2.0, APPROVED)
...
ATC-STD-244 (IBC) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (IBC) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **IBC** im Katalog-Slot ATC-STD-244 der Familie Interoperability
...
## §6 Slot-Spezifikation IBC — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-244 (Familie Interoperability, FAM-14) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-244 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
