...
standard:
  id: ATC-STD-008
  title: "Compliance Management Standard"
  version: "1.2.0"
  status: approved
  category: enterprise
...
# ATC-STD-008 — Compliance Management (v1.2.0, APPROVED)
...
ATC-STD-008 (Compliance Management) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Compliance Management) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Compliance Management** im Katalog-Slot ATC-STD-008 der Familie Enterprise & Governance
...
## §6 Slot-Spezifikation Compliance Management — verbindliche Prüfkriterien
...
- **P1** (MUSS): Anforderungskatalog (intern/normativ) mit Quelle je Regel — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Pruefkadenz, -methode und -verantwortliche — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Abweichungsbehandlung (Findings F-NNN, RCA) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Nachweisfuehrung und Aufbewahrung — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Risikobewertung von Abweichungen — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Anforderungskatalog (intern/normativ) mit Quelle je Regel
- **REQ-STD-012** (§6/P2): Pruefkadenz, -methode und -verantwortliche
- **REQ-STD-013** (§6/P3): Abweichungsbehandlung (Findings F-NNN, RCA)
- **REQ-STD-014** (§6/P4): Nachweisfuehrung und Aufbewahrung
- **REQ-STD-015** (§6/P5): Risikobewertung von Abweichungen
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-008 (Familie Enterprise & Governance, FAM-01) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-008 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
