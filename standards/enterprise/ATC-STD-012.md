...
standard:
  id: ATC-STD-012
  title: "Incident Governance Standard"
  version: "1.2.0"
  status: approved
  category: enterprise
...
# ATC-STD-012 — Incident Governance (v1.2.0, APPROVED)
...
ATC-STD-012 (Incident Governance) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Incident Governance) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Incident Governance** im Katalog-Slot ATC-STD-012 der Familie Enterprise & Governance
...
## §6 Slot-Spezifikation Incident Governance — verbindliche Prüfkriterien
...
- **P6** (MUSS): Erfassungsschema (Zeit, Schwere, Betroffenheit) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Eindaemmung vor Ursachenanalyse (Runbook) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Kommunikations- und Eskalationspflichten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Erfassungsschema (Zeit, Schwere, Betroffenheit)
- **REQ-STD-017** (§6/P7): Eindaemmung vor Ursachenanalyse (Runbook)
- **REQ-STD-018** (§6/P8): Kommunikations- und Eskalationspflichten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-012 (Familie Enterprise & Governance, FAM-01) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-012 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
