...
standard:
  id: ATC-STD-665
  title: "Third-Party Software Standard"
  version: "1.0.0"
  status: approved
  category: repository
...
# ATC-STD-665 — Third-Party Software (v1.0.0, APPROVED)
...
ATC-STD-665 (Third-Party Software) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
...
**Gilt:** Der durch den Slot-Titel (Third-Party Software) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Third-Party Software**. Er ist dem Katalog-Slot ATC-STD-665 der
...
(Third-Party Software) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-665 (Familie Supply Chain & Dependencies, FAM-37) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
*ATC-STD-665 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
