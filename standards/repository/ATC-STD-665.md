...
# ATC-STD-665 — Third-Party Software (v1.2.0, APPROVED)
...
ATC-STD-665 (Third-Party Software) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Third-Party Software** im Katalog-Slot ATC-STD-665 der Familie Supply Chain & Dependencies
...
## §6 Slot-Spezifikation Third-Party Software — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-665 (Familie Supply Chain & Dependencies, FAM-37) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-665 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
