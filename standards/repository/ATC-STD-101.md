...
# ATC-STD-101 — Branch Naming (v1.2.0, APPROVED)
...
ATC-STD-101 (Branch Naming) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Branch Naming** im Katalog-Slot ATC-STD-101 der Familie Git & Version Control
...
## §6 Slot-Spezifikation Branch Naming — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-101 (Familie Git & Version Control, FAM-06) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-101 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
