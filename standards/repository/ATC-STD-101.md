...
# ATC-STD-101 — Branch Naming (v1.0.0, APPROVED)

> **Status:** APPROVED (v1.0.0, §30-eingefroren) — Grundgerüst-Standard aus Katalog-Slot der Familie
> Git & Version Control (FAM-06); erstellt via SCR-0030. Inhaltliche Elaborierung (Volltext,
...
ATC-STD-101 (Branch Naming) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
der Familie **Git & Version Control** (FAM-06, Range ATC-STD-100..113) im ATC Enterprise Standards
...
**Gilt:** Der durch den Slot-Titel (Branch Naming) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Branch Naming**. Er ist dem Katalog-Slot ATC-STD-101 der
Familie Git & Version Control (FAM-06) zugeordnet; die Zuordnung folgt registry/framework.yaml
...
(Branch Naming) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-101 (Familie Git & Version Control, FAM-06) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
- registry/framework.yaml (FAM-06), registry/standards.yaml (Eintrag via SCR-0030)

*ATC-STD-101 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
