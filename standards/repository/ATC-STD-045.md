...
standard:
  id: ATC-STD-045
  title: "Repository Metadata Standard"
  version: "1.2.0"
  status: approved
  category: repository
...
# ATC-STD-045 — Repository Metadata (v1.2.0, APPROVED)
...
ATC-STD-045 (Repository Metadata) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Repository Metadata) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Repository Metadata** im Katalog-Slot ATC-STD-045 der Familie Repository Standards
...
## §6 Slot-Spezifikation Repository Metadata — verbindliche Prüfkriterien
...
- **P6** (MUSS): Schema-Definition (JSON-Schema/YAML) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Feldsemantik (Einheiten, Null, Referenzen) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Migrations- und Versionsregeln — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Schema-Definition (JSON-Schema/YAML)
- **REQ-STD-017** (§6/P7): Feldsemantik (Einheiten, Null, Referenzen)
- **REQ-STD-018** (§6/P8): Migrations- und Versionsregeln
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-045 (Familie Repository Standards, FAM-03) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-045 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
