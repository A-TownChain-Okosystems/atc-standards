...
# ATC-STD-660 — Software Supply Chain (v1.0.0, APPROVED)

> **Status:** APPROVED (v1.0.0, §30-eingefroren) — Grundgerüst-Standard aus Katalog-Slot der Familie
> Supply Chain & Dependencies (FAM-37); erstellt via SCR-0030. Inhaltliche Elaborierung (Volltext,
...
ATC-STD-660 (Software Supply Chain) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
der Familie **Supply Chain & Dependencies** (FAM-37, Range ATC-STD-660..667) im ATC Enterprise Standards
...
Dieser Standard adressiert **Software Supply Chain**. Er ist dem Katalog-Slot ATC-STD-660 der
Familie Supply Chain & Dependencies (FAM-37) zugeordnet; die Zuordnung folgt registry/framework.yaml
...
(Software Supply Chain) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-660 (Familie Supply Chain & Dependencies, FAM-37) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
- registry/framework.yaml (FAM-37), registry/standards.yaml (Eintrag via SCR-0030)

*ATC-STD-660 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
