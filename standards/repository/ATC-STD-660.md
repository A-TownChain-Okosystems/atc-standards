...
standard:
  id: ATC-STD-660
  title: "Software Supply Chain Standard"
  version: "1.2.0"
  status: approved
  category: repository
...
# ATC-STD-660 — Software Supply Chain (v1.2.0, APPROVED)
...
ATC-STD-660 (Software Supply Chain) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Software Supply Chain) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Software Supply Chain** im Katalog-Slot ATC-STD-660 der Familie Supply Chain & Dependencies
...
## §6 Slot-Spezifikation Software Supply Chain — verbindliche Prüfkriterien
...
- **P1** (MUSS): Lockfile-/Vendor-Disziplin — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Neueintrag-Review (Zweck/Lizenz/Pflege) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Alert-Bearbeitungspflicht — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): SBOM je Release — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): CVE-Blockaderegel (P0) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Supply Chain & Dependencies-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Lockfile-/Vendor-Disziplin
- **REQ-STD-012** (§6/P2): Neueintrag-Review (Zweck/Lizenz/Pflege)
- **REQ-STD-013** (§6/P3): Alert-Bearbeitungspflicht
- **REQ-STD-014** (§6/P4): SBOM je Release
- **REQ-STD-015** (§6/P5): CVE-Blockaderegel (P0)
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Supply Chain & Dependencies-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-660 (Familie Supply Chain & Dependencies, FAM-37) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-660 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
