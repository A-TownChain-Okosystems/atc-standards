...
standard:
  id: ATC-STD-051
  title: "Repository Deprecation Standard"
  version: "1.2.0"
  status: approved
  category: repository
...
# ATC-STD-051 — Repository Deprecation (v1.2.0, APPROVED)
...
ATC-STD-051 (Repository Deprecation) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Repository Deprecation) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Repository Deprecation** im Katalog-Slot ATC-STD-051 der Familie Repository Standards
...
## §6 Slot-Spezifikation Repository Deprecation — verbindliche Prüfkriterien
...
- **P6** (MUSS): Repository-Zweck, Namens- und Layer-Schema — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Struktur- und Ablagekonvention je Inhaltstyp — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): README-/Beschreibungs- und Label-Pflicht — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Repository-Zweck, Namens- und Layer-Schema
- **REQ-STD-017** (§6/P7): Struktur- und Ablagekonvention je Inhaltstyp
- **REQ-STD-018** (§6/P8): README-/Beschreibungs- und Label-Pflicht
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-051 (Familie Repository Standards, FAM-03) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-051 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
