...
# ATC-STD-105 — Merge Policy (v1.2.0, APPROVED)
...
ATC-STD-105 (Merge Policy) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Merge Policy) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Merge Policy** im Katalog-Slot ATC-STD-105 der Familie Git & Version Control
...
## §6 Slot-Spezifikation Merge Policy — verbindliche Prüfkriterien
...
- **P1** (MUSS): Policy-Inhalt mit Geltungsbereich und Adressaten — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Erstellung-, Freigabe- und Inkraftsetzungsprozess — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Aenderungs- und Ausserkraftsetzungsprozess mit Fristen — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Compliance-Pruefung und Abweichungsbehandlung — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Policy-Register als SSOT — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Git & Version Control-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Policy-Inhalt mit Geltungsbereich und Adressaten
- **REQ-STD-012** (§6/P2): Erstellung-, Freigabe- und Inkraftsetzungsprozess
- **REQ-STD-013** (§6/P3): Aenderungs- und Ausserkraftsetzungsprozess mit Fristen
- **REQ-STD-014** (§6/P4): Compliance-Pruefung und Abweichungsbehandlung
- **REQ-STD-015** (§6/P5): Policy-Register als SSOT
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Git & Version Control-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-105 (Familie Git & Version Control, FAM-06) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-105 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
