...
# ATC-STD-409 — NFT Security (v1.2.0, APPROVED)
...
ATC-STD-409 (NFT Security) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (NFT Security) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **NFT Security** im Katalog-Slot ATC-STD-409 der Familie NFT / Marketplace
...
## §6 Slot-Spezifikation NFT Security — verbindliche Prüfkriterien
...
- **P6** (MUSS): Metadatenmodell und Adressierung — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Integritaets-/Verfuegbarkeitspruefung — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Royalty-/Fee-Regeln maschinell pruefbar — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Metadatenmodell und Adressierung
- **REQ-STD-017** (§6/P7): Integritaets-/Verfuegbarkeitspruefung
- **REQ-STD-018** (§6/P8): Royalty-/Fee-Regeln maschinell pruefbar
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-409 (Familie NFT / Marketplace, FAM-24) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-409 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
