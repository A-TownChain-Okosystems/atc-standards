...
# ATC-STD-586 — Error UI (v1.2.0, APPROVED)
...
ATC-STD-586 (Error UI) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Error UI) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Error UI** im Katalog-Slot ATC-STD-586 der Familie UI/UX
...
## §6 Slot-Spezifikation Error UI — verbindliche Prüfkriterien
...
- **P6** (MUSS): Familienkonformitaet: UI/UX-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Familienkonformitaet: UI/UX-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-586 (Familie UI/UX, FAM-33) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-586 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
