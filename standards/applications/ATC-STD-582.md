...
# ATC-STD-582 — Component Standard (v1.2.0, APPROVED)
...
ATC-STD-582 (Component Standard) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Component Standard) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Component Standard** im Katalog-Slot ATC-STD-582 der Familie UI/UX
...
## §6 Slot-Spezifikation Component Standard — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-582 (Familie UI/UX, FAM-33) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-582 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
