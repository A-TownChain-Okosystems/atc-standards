...
# ATC-STD-400 — NFT Architecture (v1.2.0, APPROVED)
...
ATC-STD-400 (NFT Architecture) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **NFT Architecture** im Katalog-Slot ATC-STD-400 der Familie NFT / Marketplace
...
## §6 Slot-Spezifikation NFT Architecture — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-400 (Familie NFT / Marketplace, FAM-24) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-400 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
