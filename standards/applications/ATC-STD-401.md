...
# ATC-STD-401 — NFT Metadata (v1.2.0, APPROVED)
...
ATC-STD-401 (NFT Metadata) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (NFT Metadata) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **NFT Metadata** im Katalog-Slot ATC-STD-401 der Familie NFT / Marketplace
...
## §6 Slot-Spezifikation NFT Metadata — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-401 (Familie NFT / Marketplace, FAM-24) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-401 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
