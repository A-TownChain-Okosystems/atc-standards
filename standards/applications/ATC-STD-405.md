...
# ATC-STD-405 — NFT Marketplace (v1.2.0, APPROVED)
...
ATC-STD-405 (NFT Marketplace) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (NFT Marketplace) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **NFT Marketplace** im Katalog-Slot ATC-STD-405 der Familie NFT / Marketplace
...
## §6 Slot-Spezifikation NFT Marketplace — verbindliche Prüfkriterien
...
- **P6** (MUSS): Angebots-/Matching-Regeln deterministisch — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Gebuehren- und Abwicklungsmodell — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Missbrauchsschutz und Rate-Limits — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Angebots-/Matching-Regeln deterministisch
- **REQ-STD-017** (§6/P7): Gebuehren- und Abwicklungsmodell
- **REQ-STD-018** (§6/P8): Missbrauchsschutz und Rate-Limits
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-405 (Familie NFT / Marketplace, FAM-24) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-405 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
