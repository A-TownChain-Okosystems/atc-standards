...
# ATC-STD-425 — Guild (v1.2.0, APPROVED)
...
ATC-STD-425 (Guild) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Guild) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Guild** im Katalog-Slot ATC-STD-425 der Familie GameFi / Shivamon
...
## §6 Slot-Spezifikation Guild — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-425 (Familie GameFi / Shivamon, FAM-25) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-425 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
