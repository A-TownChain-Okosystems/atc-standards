...
# ATC-STD-581 — Design System (v1.2.0, APPROVED)
...
ATC-STD-581 (Design System) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Design System) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Design System** im Katalog-Slot ATC-STD-581 der Familie UI/UX
...
## §6 Slot-Spezifikation Design System — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-581 (Familie UI/UX, FAM-33) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-581 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
