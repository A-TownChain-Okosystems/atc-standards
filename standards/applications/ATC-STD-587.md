...
# ATC-STD-587 — Admin UI (v1.2.0, APPROVED)
...
ATC-STD-587 (Admin UI) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Admin UI) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Admin UI** im Katalog-Slot ATC-STD-587 der Familie UI/UX
...
## §6 Slot-Spezifikation Admin UI — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-587 (Familie UI/UX, FAM-33) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-587 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
