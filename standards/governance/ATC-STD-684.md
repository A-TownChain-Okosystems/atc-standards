...
standard:
  id: ATC-STD-684
  title: "Code of Conduct Standard"
  version: "1.2.0"
  status: approved
  category: governance
...
# ATC-STD-684 — Code of Conduct (v1.2.0, APPROVED)
...
ATC-STD-684 (Code of Conduct) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Code of Conduct) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Code of Conduct** im Katalog-Slot ATC-STD-684 der Familie Open Source & Lizenzierung
...
## §6 Slot-Spezifikation Code of Conduct — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Open Source & Lizenzierung-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Open Source & Lizenzierung-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-684 (Familie Open Source & Lizenzierung, FAM-38) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-684 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
