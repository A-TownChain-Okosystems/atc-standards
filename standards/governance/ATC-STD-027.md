...
# ATC-STD-027 — Standards Deprecation (v1.2.0, APPROVED)
...
ATC-STD-027 (Standards Deprecation) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Standards Deprecation) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Standards Deprecation** im Katalog-Slot ATC-STD-027 der Familie Standards-Governance
...
**Katalog-Referenz:** Deprecation-Pfad in ATC-STD-000 §11; Ausprägung offen
...
## §6 Slot-Spezifikation Standards Deprecation — verbindliche Prüfkriterien
...
- **P1** (MUSS): Deprecation-/Retirement-Kriterien — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Ankuendigungs- und Uebergangsfristen — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Nachfolger-Benennung und Migrationspfad — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Bestandskennzeichnung (Statusfelder) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Rueckbau und Referenzbereinigung — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Deprecation-/Retirement-Kriterien
- **REQ-STD-012** (§6/P2): Ankuendigungs- und Uebergangsfristen
- **REQ-STD-013** (§6/P3): Nachfolger-Benennung und Migrationspfad
- **REQ-STD-014** (§6/P4): Bestandskennzeichnung (Statusfelder)
- **REQ-STD-015** (§6/P5): Rueckbau und Referenzbereinigung
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-027 (Familie Standards-Governance, FAM-02) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-027 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
