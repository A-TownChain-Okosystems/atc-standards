...
standard:
  id: ATC-STD-163
  title: "Artifact Management Standard"
  version: "1.0.0"
  status: approved
...
# ATC-STD-163 — Artifact Management (v1.0.0, APPROVED)

> **Status:** APPROVED (v1.0.0, §30-eingefroren) — Grundgerüst-Standard aus Katalog-Slot der Familie
> CI/CD & DevOps (FAM-09); erstellt via SCR-0030. Inhaltliche Elaborierung (Volltext,
...
ATC-STD-163 (Artifact Management) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
der Familie **CI/CD & DevOps** (FAM-09, Range ATC-STD-160..174) im ATC Enterprise Standards
...
**Gilt:** Der durch den Slot-Titel (Artifact Management) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Artifact Management**. Er ist dem Katalog-Slot ATC-STD-163 der
Familie CI/CD & DevOps (FAM-09) zugeordnet; die Zuordnung folgt registry/framework.yaml
...
(Artifact Management) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-163 (Familie CI/CD & DevOps, FAM-09) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
- registry/framework.yaml (FAM-09), registry/standards.yaml (Eintrag via SCR-0030)

*ATC-STD-163 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
