...
# ATC-STD-171 — Kubernetes Standard (v1.2.0, APPROVED)
...
ATC-STD-171 (Kubernetes Standard) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Kubernetes Standard** im Katalog-Slot ATC-STD-171 der Familie CI/CD & DevOps
...
## §6 Slot-Spezifikation Kubernetes Standard — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-171 (Familie CI/CD & DevOps, FAM-09) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-171 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
