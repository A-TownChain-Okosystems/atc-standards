...
ATC-STD-169 (Infrastructure as Code) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Infrastructure as Code) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Infrastructure as Code** im Katalog-Slot ATC-STD-169 der Familie CI/CD & DevOps
...
## §6 Slot-Spezifikation Infrastructure as Code — verbindliche Prüfkriterien
...
- **P1** (MUSS): Komponenten-/Modulgrenzen und Verantwortlichkeiten — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Schichten- und Abhaengigkeitsregeln — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Verbotsregeln (Zweck-Duplikate, Grenzverletzungen) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Dokumentation der Struktur (Diagramm/Register) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Ausnahmebehandlung mit Begruendung — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Komponenten-/Modulgrenzen und Verantwortlichkeiten
- **REQ-STD-012** (§6/P2): Schichten- und Abhaengigkeitsregeln
- **REQ-STD-013** (§6/P3): Verbotsregeln (Zweck-Duplikate, Grenzverletzungen)
- **REQ-STD-014** (§6/P4): Dokumentation der Struktur (Diagramm/Register)
- **REQ-STD-015** (§6/P5): Ausnahmebehandlung mit Begruendung
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-169 (Familie CI/CD & DevOps, FAM-09) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-169 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
