...
# ATC-STD-601 — Mobile (v1.2.0, APPROVED)
...
ATC-STD-601 (Mobile) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Mobile** im Katalog-Slot ATC-STD-601 der Familie Mobile / Desktop / OS
...
## §6 Slot-Spezifikation Mobile — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-601 (Familie Mobile / Desktop / OS, FAM-34) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-601 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
