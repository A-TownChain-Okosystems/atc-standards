...
# ATC-STD-602 — Desktop (v1.2.0, APPROVED)
...
ATC-STD-602 (Desktop) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Desktop) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Desktop** im Katalog-Slot ATC-STD-602 der Familie Mobile / Desktop / OS
...
**Katalog-Referenz:** atc-windows-edition/atc-linux-edition, egui
...
## §6 Slot-Spezifikation Desktop — verbindliche Prüfkriterien
...
- **P1** (MUSS): Plattform-Target und Runtime (Rust std, egui) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Paket-/Distributionsmodell — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Update-/Rollback-Mechanismus — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Geraete-/OS-Kompatibilitaetsmatrix — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Kernel-Unabhaengigkeit (ersetzt ShivaCore nicht) — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-011** (§6/P1): Plattform-Target und Runtime (Rust std, egui)
- **REQ-STD-012** (§6/P2): Paket-/Distributionsmodell
- **REQ-STD-013** (§6/P3): Update-/Rollback-Mechanismus
- **REQ-STD-014** (§6/P4): Geraete-/OS-Kompatibilitaetsmatrix
- **REQ-STD-015** (§6/P5): Kernel-Unabhaengigkeit (ersetzt ShivaCore nicht)
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-602 (Familie Mobile / Desktop / OS, FAM-34) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-602 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
