...
# ATC-AAS-023 — Agent Role Standard (v1.0.0, CANDIDATE)

> **Status:** CANDIDATE · **Priorität:** P2 · **Erweitert:** ATC-STD-AI-DEV-012 (Multi-Agent Coordination), AGENT_PROTOCOL (1-Agent-per-Repo)
