...
# ATC-AAS-010 — Agent Evidence Standard (v1.0.0, CANDIDATE)

> **Status:** CANDIDATE · **Priorität:** P0 · **Erweitert:** ATC-STD-AI-DEV-005 (Evidence-Pflicht), AI-DEV-008 §2 (Validierung mit CI-Run)
