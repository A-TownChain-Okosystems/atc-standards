...
# ATC-STD-561 — Functional Requirements (v1.0.0, APPROVED)
...
ATC-STD-561 (Functional Requirements) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
...
Dieser Standard adressiert **Functional Requirements**. Er ist dem Katalog-Slot ATC-STD-561 der
...
(Functional Requirements) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-561 (Familie Requirements Engineering, FAM-32) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
*ATC-STD-561 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
