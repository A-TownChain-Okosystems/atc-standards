...
# ATC-STD-089 — Configuration Management (v1.2.0, APPROVED)
...
ATC-STD-089 (Configuration Management) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Configuration Management** im Katalog-Slot ATC-STD-089 der Familie Software Development
...
## §6 Slot-Spezifikation Configuration Management — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Software Development-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Software Development-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-089 (Familie Software Development, FAM-05) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-089 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
