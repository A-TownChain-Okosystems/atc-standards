...
standard:
  id: ATC-STD-620
  title: "ATCLang Architecture Standard"
  version: "1.2.0"
  status: approved
...
# ATC-STD-620 — ATCLang Architecture (v1.2.0, APPROVED)
...
ATC-STD-620 (ATCLang Architecture) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (ATCLang Architecture) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **ATCLang Architecture** im Katalog-Slot ATC-STD-620 der Familie ATCLang
...
**Katalog-Referenz:** atclang (L0), AD-022 Gates G1-G6
...
## §6 Slot-Spezifikation ATCLang Architecture — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: ATCLang-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: ATCLang-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-620 (Familie ATCLang, FAM-35) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-620 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
