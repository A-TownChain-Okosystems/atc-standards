...
# ATC-STD-441 — REST API (v1.2.0, APPROVED)
...
ATC-STD-441 (REST API) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (REST API) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **REST API** im Katalog-Slot ATC-STD-441 der Familie API Standards
...
## §6 Slot-Spezifikation REST API — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-441 (Familie API Standards, FAM-26) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-441 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
