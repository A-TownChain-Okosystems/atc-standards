...
# ATC-STD-140 — QA Framework (v1.2.0, APPROVED)
...
ATC-STD-140 (QA Framework) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (QA Framework) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **QA Framework** im Katalog-Slot ATC-STD-140 der Familie Testing & Quality Assurance
...
## §6 Slot-Spezifikation QA Framework — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Testing & Quality Assurance-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Testing & Quality Assurance-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-140 (Familie Testing & Quality Assurance, FAM-08) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-140 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
