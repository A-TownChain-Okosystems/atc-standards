...
# ATC-STD-447 — Rate Limiting (v1.2.0, APPROVED)
...
ATC-STD-447 (Rate Limiting) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Rate Limiting** im Katalog-Slot ATC-STD-447 der Familie API Standards
...
**Katalog-Referenz:** Kernel K15 Rate-Limit als Referenz
...
## §6 Slot-Spezifikation Rate Limiting — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: API Standards-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: API Standards-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-447 (Familie API Standards, FAM-26) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-447 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
