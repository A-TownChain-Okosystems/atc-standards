...
# ATC-STD-461 — Data Model (v1.2.0, APPROVED)
...
ATC-STD-461 (Data Model) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Data Model** im Katalog-Slot ATC-STD-461 der Familie Datenstandards
...
## §6 Slot-Spezifikation Data Model — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-461 (Familie Datenstandards, FAM-27) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-461 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
