...
standard:
  id: ATC-STD-144
  title: "End-to-End Testing Standard"
  version: "1.2.0"
  status: approved
...
# ATC-STD-144 — End-to-End Testing (v1.2.0, APPROVED)
...
ATC-STD-144 (End-to-End Testing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (End-to-End Testing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **End-to-End Testing** im Katalog-Slot ATC-STD-144 der Familie Testing & Quality Assurance
...
## §6 Slot-Spezifikation End-to-End Testing — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-144 (Familie Testing & Quality Assurance, FAM-08) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-144 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
