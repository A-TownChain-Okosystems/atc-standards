...
# ATC-STD-141 — Unit Testing (v1.2.0, APPROVED)
...
ATC-STD-141 (Unit Testing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Unit Testing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Unit Testing** im Katalog-Slot ATC-STD-141 der Familie Testing & Quality Assurance
...
## §6 Slot-Spezifikation Unit Testing — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-141 (Familie Testing & Quality Assurance, FAM-08) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-141 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
