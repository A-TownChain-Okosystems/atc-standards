...
# ATC-STD-624 — VM (v1.2.0, APPROVED)
...
ATC-STD-624 (VM) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (VM) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **VM** im Katalog-Slot ATC-STD-624 der Familie ATCLang
...
**Katalog-Referenz:** ATVM (atc-vm, L0)
...
## §6 Slot-Spezifikation VM — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-624 (Familie ATCLang, FAM-35) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-624 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
