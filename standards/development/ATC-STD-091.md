...
# ATC-STD-091 — Testing (v1.2.0, APPROVED)
...
## §6 Slot-Spezifikation Testing — verbindliche Prüfkriterien
...
- **P6** (MUSS): Familienkonformitaet: Software Development-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Software Development-Kernregeln KR-1..KR-6 eingehalten
...
*ATC-STD-091 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
