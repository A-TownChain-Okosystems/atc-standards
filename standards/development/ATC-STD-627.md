...
standard:
  id: ATC-STD-627
  title: "Standard Library Standard"
  version: "1.2.0"
  status: approved
...
# ATC-STD-627 — Standard Library (v1.2.0, APPROVED)
...
ATC-STD-627 (Standard Library) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Standard Library) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Standard Library** im Katalog-Slot ATC-STD-627 der Familie ATCLang
...
## §6 Slot-Spezifikation Standard Library — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-627 (Familie ATCLang, FAM-35) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-627 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
