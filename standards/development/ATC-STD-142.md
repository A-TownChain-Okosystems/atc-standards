...
# ATC-STD-142 — Integration Testing (v1.2.0, APPROVED)
...
ATC-STD-142 (Integration Testing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Integration Testing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Integration Testing** im Katalog-Slot ATC-STD-142 der Familie Testing & Quality Assurance
...
## §6 Slot-Spezifikation Integration Testing — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-142 (Familie Testing & Quality Assurance, FAM-08) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-142 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
