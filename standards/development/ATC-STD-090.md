...
# ATC-STD-090 — Environment Management (v1.2.0, APPROVED)
...
ATC-STD-090 (Environment Management) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Environment Management** im Katalog-Slot ATC-STD-090 der Familie Software Development
...
## §6 Slot-Spezifikation Environment Management — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-090 (Familie Software Development, FAM-05) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-090 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
