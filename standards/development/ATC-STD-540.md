...
# ATC-STD-540 — Project Management (v1.2.0, APPROVED)
...
ATC-STD-540 (Project Management) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Project Management) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Project Management** im Katalog-Slot ATC-STD-540 der Familie Projektmanagement
...
## §6 Slot-Spezifikation Project Management — verbindliche Prüfkriterien
...
- **P1** (MUSS): Plan-/Sprint-Modell und Kadenz — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P2** (MUSS): Meilensteingovernance (Lifecycle, Evidence) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P3** (MUSS): Human-Gate fuer Abschlussentscheidungen — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P4** (MUSS): Track-Trennung (Kernel/Konsolidierung) — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P5** (MUSS): Status- und Fortschrittsnachweis — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P6** (MUSS): Familienkonformitaet: Projektmanagement-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-011** (§6/P1): Plan-/Sprint-Modell und Kadenz
- **REQ-STD-012** (§6/P2): Meilensteingovernance (Lifecycle, Evidence)
- **REQ-STD-013** (§6/P3): Human-Gate fuer Abschlussentscheidungen
- **REQ-STD-014** (§6/P4): Track-Trennung (Kernel/Konsolidierung)
- **REQ-STD-015** (§6/P5): Status- und Fortschrittsnachweis
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Projektmanagement-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-540 (Familie Projektmanagement, FAM-31) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-540 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
