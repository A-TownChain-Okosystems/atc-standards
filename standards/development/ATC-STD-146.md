...
standard:
  id: ATC-STD-146
  title: "Performance Testing Standard"
  version: "1.2.0"
  status: approved
...
# ATC-STD-146 — Performance Testing (v1.2.0, APPROVED)
...
ATC-STD-146 (Performance Testing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Performance Testing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Performance Testing** im Katalog-Slot ATC-STD-146 der Familie Testing & Quality Assurance
...
## §6 Slot-Spezifikation Performance Testing — verbindliche Prüfkriterien
...
- **P6** (MUSS): Familienkonformitaet: Testing & Quality Assurance-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Testing & Quality Assurance-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-146 (Familie Testing & Quality Assurance, FAM-08) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-146 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
