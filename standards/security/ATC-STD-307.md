...
# ATC-STD-307 — Network Security (v1.2.0, APPROVED)
...
ATC-STD-307 (Network Security) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Network Security** im Katalog-Slot ATC-STD-307 der Familie Cybersecurity
...
## §6 Slot-Spezifikation Network Security — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-307 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-307 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
