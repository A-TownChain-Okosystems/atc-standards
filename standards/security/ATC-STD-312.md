...
standard:
  id: ATC-STD-312
  title: "Penetration Testing Standard"
  version: "1.2.0"
  status: approved
  category: security
...
# ATC-STD-312 — Penetration Testing (v1.2.0, APPROVED)
...
ATC-STD-312 (Penetration Testing) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Penetration Testing) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Penetration Testing** im Katalog-Slot ATC-STD-312 der Familie Cybersecurity
...
## §6 Slot-Spezifikation Penetration Testing — verbindliche Prüfkriterien
...
- **P6** (MUSS): Familienkonformitaet: Cybersecurity-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Familienkonformitaet: Cybersecurity-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-312 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-312 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
