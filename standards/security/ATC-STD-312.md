...
# ATC-STD-312 — Penetration Testing (v1.0.0, APPROVED)

> **Status:** APPROVED (v1.0.0, §30-eingefroren) — Grundgerüst-Standard aus Katalog-Slot der Familie
> Cybersecurity (FAM-18); erstellt via SCR-0030. Inhaltliche Elaborierung (Volltext,
...
ATC-STD-312 (Penetration Testing) ist der Grundgerüst-Standard für den gleichnamigen Katalog-Slot
der Familie **Cybersecurity** (FAM-18, Range ATC-STD-300..313) im ATC Enterprise Standards
...
Dieser Standard adressiert **Penetration Testing**. Er ist dem Katalog-Slot ATC-STD-312 der
Familie Cybersecurity (FAM-18) zugeordnet; die Zuordnung folgt registry/framework.yaml
...
(Penetration Testing) sind bei der Elaborierung zwingend zu bewerten; bis dahin werden keine
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-312 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN 08.09.2026, 02:15 UTC+2 — APPROVED, normativ,
...
- registry/framework.yaml (FAM-18), registry/standards.yaml (Eintrag via SCR-0030)

*ATC-STD-312 v1.0.0 · Grundgerüst via SCR-0030 · Aurora (Superagent) · 08.09.2026*
