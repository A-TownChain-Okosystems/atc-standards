...
# ATC-STD-309 — Supply Chain Security (v1.2.0, APPROVED)
...
ATC-STD-309 (Supply Chain Security) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Supply Chain Security) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Supply Chain Security** im Katalog-Slot ATC-STD-309 der Familie Cybersecurity
...
## §6 Slot-Spezifikation Supply Chain Security — verbindliche Prüfkriterien
...
- **P6** (MUSS): Lockfile-/Vendor-Disziplin — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
- **P7** (MUSS): Neueintrag-Review (Zweck/Lizenz/Pflege) — Nachweis: Design-/Konzeptdokument + AUD-Record
- **P8** (MUSS): Alert-Bearbeitungspflicht — Nachweis: Validator-/Testlauf bzw. dokumentierte Prüfung
...
- **REQ-STD-016** (§6/P6): Lockfile-/Vendor-Disziplin
- **REQ-STD-017** (§6/P7): Neueintrag-Review (Zweck/Lizenz/Pflege)
- **REQ-STD-018** (§6/P8): Alert-Bearbeitungspflicht
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-309 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-309 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
