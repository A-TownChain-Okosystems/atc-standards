...
# ATC-STD-311 — Vulnerability Management (v1.2.0, APPROVED)
...
ATC-STD-311 (Vulnerability Management) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Vulnerability Management** im Katalog-Slot ATC-STD-311 der Familie Cybersecurity
...
## §6 Slot-Spezifikation Vulnerability Management — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-311 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-311 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
