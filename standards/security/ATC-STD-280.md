...
# ATC-STD-280 — Identity (v1.2.0, APPROVED)
...
ATC-STD-280 (Identity) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Identity) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Identity** im Katalog-Slot ATC-STD-280 der Familie Identity & Reputation
...
**Katalog-Referenz:** Kernel K6 DID als Referenzimplementierung
...
## §6 Slot-Spezifikation Identity — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-280 (Familie Identity & Reputation, FAM-17) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-280 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
