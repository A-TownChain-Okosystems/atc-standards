...
standard:
  id: ATC-STD-286
  title: "Credential Verification Standard"
  version: "1.2.0"
  status: approved
  category: security
...
# ATC-STD-286 — Credential Verification (v1.2.0, APPROVED)
...
ATC-STD-286 (Credential Verification) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
**Gilt:** Der durch den Slot-Titel (Credential Verification) bezeichnete Gegenstandsbereich im
...
Dieser Standard adressiert **Credential Verification** im Katalog-Slot ATC-STD-286 der Familie Identity & Reputation
...
## §6 Slot-Spezifikation Credential Verification — verbindliche Prüfkriterien
...
- **P5** (MUSS): Familienkonformitaet: Identity & Reputation-Kernregeln KR-1..KR-6 eingehalten — Nachweis: Design-/Konzeptdokument + AUD-Record
...
- **REQ-STD-015** (§6/P5): Familienkonformitaet: Identity & Reputation-Kernregeln KR-1..KR-6 eingehalten
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-286 (Familie Identity & Reputation, FAM-17) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-286 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
