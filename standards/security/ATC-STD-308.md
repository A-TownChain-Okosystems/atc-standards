...
# ATC-STD-308 — Endpoint Security (v1.2.0, APPROVED)
...
ATC-STD-308 (Endpoint Security) ist der Standard für den gleichnamigen Katalog-Slot der Familie
...
Dieser Standard adressiert **Endpoint Security** im Katalog-Slot ATC-STD-308 der Familie Cybersecurity
...
## §6 Slot-Spezifikation Endpoint Security — verbindliche Prüfkriterien
...
- **1.0.0** (2026-09-08): Initial Release — Grundgerüst-Standard aus
  Katalog-Slot ATC-STD-308 (Familie Cybersecurity, FAM-18) via SCR-0030; §9-FREIGEGEBEN
...
*ATC-STD-308 v1.2.0 · Slot-Fertigbau via SCR-0034 · Aurora (Superagent) · 08.09.2026*
