...
# ATC-STD-MAINT-001 — Maintenance Classification Standard (v1.0.0, DRAFT)

> **Status:** DRAFT — wartet auf §9-Freigabe (ATC-STD-000). Die vier Klassen M0-M3 sind verbindlich.
