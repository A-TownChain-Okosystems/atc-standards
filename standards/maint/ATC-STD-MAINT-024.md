...
# ATC-STD-MAINT-024 — Cross-Ecosystem Maintenance Standard (v1.0.0, DRAFT)
...
3. Kompatibilitaet wird an allen Schichtgrenzen geprueft (MAINT-000 §8; Pruefkette MAINT-009 als
   Muster).
