...
Geltung: ATC-STD-000 §19 (Change Management). Dieses Dokument macht den
...
- **IMPLEMENTED:** Umsetzung per Commits referenziert; Version des betroffenen
  Standards gemaess ATC-STD-000 §20-21 (Breaking = MAJOR).
...
| SCR-0002 | ATC-STD-000 | L↔R-Compliance-Mapping | OBSOLETE | Aufgeloest durch Formalfassung §22 (07.09.) |
| SCR-0003 | ATC-STD-000 | §33-Integritaetsumsetzung (Protected main, CODEOWNERS, Signed Tags) | PROPOSED (Teil-Umsetzung: CODEOWNERS) | PENDING |
| SCR-0004 | ATC-STD-000 | Rollen- und Berechtigungsmodell | PROPOSED | PENDING |

## Regeln

1. Aenderungen an STABLE-Standards NUR via SCR (ATC-STD-000 §19). Fuer
...
4. Emergency-Aenderungen (ATC-STD-000 §31) bekommen ein nachgeholtes SCR mit
